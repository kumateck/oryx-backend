...
namespace INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20250626220940_UpdateRouteOperationAction")]
    partial class UpdateRouteOperationAction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DOMAIN.Entities.Routes.RouteOperationAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ProductionActivityStepUserId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RouteResponsibleRoleId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RouteResponsibleUserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductionActivityStepUserId");

                    b.HasIndex("RouteResponsibleRoleId");

                    b.HasIndex("RouteResponsibleUserId");

                    b.ToTable("RouteOperationAction");
                });
            ...
            modelBuilder.Entity("DOMAIN.Entities.Routes.RouteOperationAction", b =>
                {
                    ...
                    b.HasOne("DOMAIN.Entities.Products.Production.ProductionActivityStepUser", null)
                        .WithMany("Actions")
                        .HasForeignKey("ProductionActivityStepUserId");

                    b.HasOne("DOMAIN.Entities.Routes.RouteResponsibleRole", null)
                        .WithMany("Actions")
                        .HasForeignKey("RouteResponsibleRoleId");

                    b.HasOne("DOMAIN.Entities.Routes.RouteResponsibleUser", null)
                        .WithMany("Actions")
                        .HasForeignKey("RouteResponsibleUserId");
