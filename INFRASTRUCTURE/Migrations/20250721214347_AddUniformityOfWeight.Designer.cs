...
namespace INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20250721214347_AddUniformityOfWeight")]
    partial class AddUniformityOfWeight
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DOMAIN.Entities.MaterialAnalyticalRawData.MaterialAnalyticalRawData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DOMAIN.Entities.MaterialSpecifications.MaterialSpecification", b =>
                {
                    ...
                    b.OwnsMany("DOMAIN.Entities.MaterialSpecifications.TestSpecification", "TestSpecifications", b1 =>
                        {
                            b1.Property<Guid>("MaterialSpecificationId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<string>("ReleaseSpecification")
                                .HasColumnType("text");

                            b1.Property<int>("SrNumber")
                                .HasColumnType("integer");

                            b1.Property<int>("TestName")
                                .HasColumnType("integer");

                            b1.HasKey("MaterialSpecificationId", "Id");

                            b1.ToTable("MaterialSpecifications_TestSpecifications");
                    ...
                    b.Navigation("TestSpecifications");
                });
            ...
            modelBuilder.Entity("DOMAIN.Entities.ProductSpecifications.ProductSpecification", b =>
                {
                    ...
                    b.OwnsMany("DOMAIN.Entities.MaterialSpecifications.TestSpecification", "TestSpecifications", b1 =>
                        {
                            b1.Property<Guid>("ProductSpecificationId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ProductSpecificationId", "Id");

                            b1.ToTable("ProductSpecifications_TestSpecifications");
            ...
            modelBuilder.Entity("DOMAIN.Entities.ProductionOrders.ProductionOrder", b =>
                {
                    ...
                    b.OwnsMany("DOMAIN.Entities.ProductionOrders.ProductionOrderProducts", "ProductionOrderProducts", b1 =>
                        {
                    ...
                    b.Navigation("ProductionOrderProducts");
                });
